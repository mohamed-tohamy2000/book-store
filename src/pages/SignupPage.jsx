                ...
                <Formik initialValues={{
                    ...
                    <Form className="w-200 p-4 bg-[#F5F5F5] flex flex-col gap-4">
                        <div className='grid grid-cols-2 gap-5'>
                            <UiComponant name="firstname" label="First Name" placeholder="John" type="firstname" />
                            <UiComponant name="lastname" label="Last Name" placeholder="Smith" type="lastname" />
                        ...
                        <SoBtn p="Already have an account?" to={"/login"} ptow=" Login" ask=" " stet=" Agree with Terms & Conditions" lable="Sign Up" />
