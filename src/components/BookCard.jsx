      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="w-88.5 text-[14px] text-[#22222280]">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio earum neque
            reiciendis ipsa expedita eius modi maxime veniam obcaecati.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between gap-4">
            <Button
              type="button"
              isMainBtn={true}
              classn="w-full text-white font-semibold text flex items-center justify-center gap-2 text-[16px]"
            ...
            <Button
              type="button"
              isMainBtn={false}
              classn="w-fit text-mainColor text-xl"
